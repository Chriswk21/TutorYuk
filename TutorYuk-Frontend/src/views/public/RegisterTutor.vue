...
const submitRegistration = async () => {
  try {
    ...
    alert('Pendaftaran tutor berhasil dikirim. Tim akan meninjaunya.')
    form.value = {
      name: '',
      email: '',
      phone_number: '',
...
<style scoped>
.register-container { padding: 60px 20px; display: flex; justify-content: center; background: #f8fafc; }
